...
namespace Otp.Controllers
{
    ...
    public class OtpController : ControllerBase
    {
        ...
        public OtpController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ITokenService tokenService, IRedisService redisService, IPublishEndpoint publishEndpoint, SmsPanel smsPanel)
        {
