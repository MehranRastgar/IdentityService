...
builder.Services.AddCors(options =>
{
  ...
  {
    builder.WithOrigins(["http://localhost:3000", "https://localhost:3000", "https://192.168.8.103:3000", "https://localhost:10502/", "http://bugtech.ir", "https://whatsapp.bugtech.ir/", "http://localhost:10500"]) // Specify the allowed origin(s)
           .AllowAnyMethod()
           .AllowAnyHeader()
